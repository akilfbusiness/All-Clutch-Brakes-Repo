...
// Requires SANITY_API_WRITE_TOKEN env var (Editor or above token from sanity.io/manage)
...
const siteSettings = {
  ...
  heroAnswerCapsule:
    "Expert clutch replacement, brake repairs, and transmission service for all makes and models. Based in St Marys, Adelaide — call (08) 8277 8122 for a free quote.",
  ...
  homeServicesSubheading:
    "From clutch replacements to full brake overhauls — we handle everything in-house with no subcontracting.",
  ...
  homeCtaBody:
    "Call us on (08) 8277 8122 or send a message and we will get back to you promptly with an honest, fixed price.",
  homeFaqs: [
    {
      question: "How do I know if my clutch needs replacing?",
      answer:
        "Common signs include slipping (engine revs rise but speed does not increase), difficulty changing gears, a burning smell, or a spongy/stiff clutch pedal. Bring it in and we will inspect it for free.",
    },
    {
      question: "How long does a clutch replacement take?",
      answer:
        "Most clutch replacements take 3–5 hours. In many cases your car will be ready the same day you drop it off.",
    },
    {
      question: "How often should brake pads be replaced?",
      answer:
        "Brake pads typically need replacing every 25,000–70,000 km depending on driving style. If you hear squealing or grinding when braking, get them checked immediately.",
    },
    {
      question: "Do you service all makes and models?",
      answer:
        "Yes — we work on all makes and models including European, Japanese, American, Korean, and 4WD vehicles.",
    },
    {
      question: "Do you provide a warranty on clutch and brake work?",
      answer:
        "Yes. All parts and labour come with a warranty. Ask us for details when you book.",
    },
  ],
  ...
  aboutAnswerCapsule:
    "All Clutch & Brake Service is an Adelaide-based specialist workshop with over 30 years experience in clutch, brake, and transmission repairs for all makes and models.",
  aboutMissionHeading: "Our Mission",
  aboutMissionBody:
    "To provide honest, fixed-price automotive repairs with no hidden costs, no subcontracting, and no unnecessary work — every time.",
  ...
  contactAnswerCapsule:
    "Call (08) 8277 8122 or visit us at Unit 1/3 Adelaide Terrace, St Marys SA 5042. Monday to Friday 8am–5pm.",
  contactFormHeading: "Send Us a Message",
  contactFormSubheading:
    "Describe your vehicle issue and we will get back to you with an honest quote.",
  ...
  servicesPageAnswerCapsule:
    "All Clutch & Brake Service offers expert clutch replacement, brake repairs, and transmission service for all makes and models in Adelaide, SA.",

  // ── Locations Page ────────────────────────────────────────────────────────────
  locationsPageHeading: "Serving All of Adelaide",
  locationsPageAnswerCapsule:
    "Based in St Marys, we service vehicles from all Adelaide suburbs and surrounding South Australian regions.",
  ...
  defaultSeoDescription:
    "Adelaide's clutch and brake specialists. Expert clutch replacement, brake repairs, and transmission service. All makes and models. St Marys SA. Call (08) 8277 8122.",
}

async function seed() {
  console.log("Seeding Sanity siteSettings...")
  try {
    const result = await client.createOrReplace(siteSettings)
    console.log("Done! siteSettings document created:", result._id)
  } catch (err) {
