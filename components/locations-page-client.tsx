  ...
  return (
    <>
      ...
      <section className="relative pt-40 pb-24 md:pt-48 md:pb-32 bg-background overflow-hidden border-b border-border">
        ...
        <div className="container relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[88px] font-black tracking-tight leading-[0.95] text-foreground mb-8">{pageTitle}</h1>
      ...
      <section className="py-20 md:py-28 bg-background border-b border-border">
        <div className="container">
          <div className="flex items-center justify-between mb-14">
            <h2 className="text-2xl md:text-3xl font-black text-foreground tracking-tight">Service Regions</h2>
            ...
            {displayRegions.map((region, i) => (
              <motion.article key={region.slug} variants={fadeUp}
                ...
                <div className="relative z-10 p-7 md:p-9">
                  <span aria-hidden className="absolute top-4 right-5 text-[64px] font-black leading-none text-foreground/[0.04] select-none pointer-events-none">
                  ...
                  <h3 className="text-lg font-black text-foreground group-hover:text-accent transition-colors duration-300 tracking-tight mb-3">
      ...
      {suburbs.length > 0 && (
        <section className="py-20 md:py-28 bg-background border-b border-border">
          <div className="container">
            <h2 className="text-2xl md:text-3xl font-black text-foreground tracking-tight mb-10">Key Service Areas</h2>
      ...
      {faqs.length > 0 && (
        <section className="relative py-24 md:py-32 bg-background border-b border-border">
          <span aria-hidden className="absolute top-6 right-6 md:right-10 text-[100px] md:text-[160px] font-black leading-none text-foreground/[0.03] select-none pointer-events-none">FAQ</span>
          <div className="container">
            <div className="grid lg:grid-cols-[2fr_3fr] gap-16 lg:gap-24">
              <div className="lg:sticky lg:top-32 lg:self-start">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-tight mb-8">Common Questions</h2>
      ...
      <section className="bg-accent overflow-hidden">
        <div className="container">
          <div className="grid md:grid-cols-[1fr_auto] items-center gap-10 py-16 md:py-20">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-black tracking-tight leading-tight">Not Sure If We Service Your Area?</h2>
