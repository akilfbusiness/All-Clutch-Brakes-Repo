...
const navigationItem = defineArrayMember({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Site Page",
      type: "string",
      description: "Select one of the site's built-in pages.",
      hidden: ({ parent }) => parent?.linkType === "external",
      options: {
        list: [
          { title: "Home", value: "/" },
          ...
          { title: "FAQ", value: "/faq" },
          { title: "About — What We Do", value: "/what-we-do" },
          { title: "About — Projects", value: "/projects" },
          { title: "About — Meet Our Staff", value: "/meet-our" },
          { title: "Products — Brands", value: "/brands" },
          { title: "Products — Featured Products & News", value: "/featured-product" },
          { title: "Products — Brake Pipes", value: "/brake-pipes" },
          { title: "Products — Specialty Parts", value: "/miscellaneous" },
          { title: "Services (listing)", value: "/services" },
          { title: "Locations (listing)", value: "/locations" },
    ...
    defineField({
      ...
      type: "string",
      description: "Only use this if the page is not in the list above. Manually enter a path (e.g. '/my-custom-page'). Include the leading slash.",
      hidden: ({ parent }) => parent?.linkType === "external",
    }),
    defineField({
      name: "openInNewTab",
              ...
              of: [
                {
                  ...
                  fields: [
                    ...
                    defineField({
                      ...
                      title: "Custom URL Path",
                      type: "string",
                      description: "Only use this if the page is not in the list above. Manually enter a path. Include the leading slash.",
                      hidden: ({ parent }) => parent?.linkType === "external",
                    }),
                  ],
                  preview: {
