...
const navigationItem = defineArrayMember({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      description: "Manually enter a URL path (e.g. '/what-we-do', '/projects', '/meet-our', '/contact', '/brands'). Use this for pages that are not Sanity documents. Include the leading slash.",
      hidden: ({ parent }) => parent?.linkType === "external",
    }),
    defineField({
      name: "openInNewTab",
      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({
              ...
              title: "Custom URL Path",
              type: "string",
              description: "Manually enter a URL path (e.g. '/what-we-do', '/projects'). Include the leading slash.",
              hidden: ({ parent }) => parent?.linkType === "external",
            }),
            defineField({
              name: "openInNewTab",
              ...
              of: [
                {
                  ...
                  fields: [
                    ...
                    defineField({
                      ...
                      title: "Custom URL Path",
                      type: "string",
                      description: "Manually enter a URL path (e.g. '/what-we-do'). Include the leading slash.",
                      hidden: ({ parent }) => parent?.linkType === "external",
                    }),
                  ],
                  preview: {
