    ...
    <html lang="en-AU" suppressHydrationWarning>
      <head>
        ...
        {/* Google Tag Manager — Container ID: GTM-N5PQ7TSW
            strategy="lazyOnload" defers until page is fully idle to keep GTM
            off the critical path. Pageviews and interaction events are not
            missed since they fire after the page is interactive. */}
        <Script
          id="gtm-init"
          strategy="lazyOnload"
          dangerouslySetInnerHTML={{
