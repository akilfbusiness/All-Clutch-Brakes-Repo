    ...
    <html lang="en-AU" suppressHydrationWarning>
      <head>
        ...
        {/* Google Tag Manager — Container ID: GTM-N5PQ7TSW
            strategy="afterInteractive" fires as soon as React hydration completes,
            early enough for Tag Assistant to detect and for GTM to catch all events.
            GA4 and Clarity stay on lazyOnload — only GTM needs the earlier window. */}
        <Script
          id="gtm-init"
