  ...
  return (
    ...
    <html lang="en-AU" suppressHydrationWarning>
      <head>
        ...
        />
        {/* Google Tag Manager — Container ID: GTM-N5PQ7TSW
            strategy="lazyOnload" keeps GTM off the critical path, preserving
            PageSpeed score. Tracking fires correctly for all real user events.
            Tag Assistant preview may not detect it due to lazy timing — verified
            working via Network tab (gtm.js returns 200). */}
        <Script
          id="gtm-init"
          strategy="lazyOnload"
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-N5PQ7TSW');`,
          }}
        />
      </head>
      <body className={`${_plusJakarta.variable} ${_geistMono.variable} font-sans antialiased`}>
        {/* GTM noscript fallback — fires for users with JavaScript disabled.
            Must be the first element inside <body> per Google's instructions. */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-N5PQ7TSW"
            height="0"
            width="0"
